...
const index = (req, res) => {
    res.render("../views/orders", { order: order.getOrders() });
 }
...
const getOrder = async (req, res) => {
    const order = await orderService.getOrderByIDClient(req.params.id);
    if (!order) {
 ...
 module.exports={
  updateNumberOfPassengers,updatePrice,getOrder,getOrders,createOrder}      
